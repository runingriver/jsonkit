...
func (j *JsonCutterImpl) CutterMap(ctx context.Context, jsonMap map[string]interface{}, cfg *jconf.CutterConfig) (map[string]interface{}, error) {
...
func (j *JsonCutterImpl) DoForDeepCut(ctx context.Context, jsonMap map[string]interface{}, cfg *jconf.DeepCut) (map[string]interface{}, error) {
	return jsonMap, nil
}

func (j *JsonCutterImpl) DoForOverrunCut(ctx context.Context, jsonMap map[string]interface{}, cfg *jconf.OverrunCut) (map[string]interface{}, error) {
	return jsonMap, nil
}
